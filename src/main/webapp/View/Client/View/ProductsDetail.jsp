...
<head>
    ...
    <link href="View/Client/Css/Index.css" rel="stylesheet">
</head>
<body>
<div class="container">
    <div class="row">
    ...
    <div style="margin-top: 20px" class="row">
        ...
        <a type="button" class="btn btn-primary btn-md mr-1 mb-2" href="/user?ac=addItem&pId=${product.getId()}">Buy now</a>
            <a href="/user?ac=addItem&pId=${product.getId()}" class="btn btn-light">
